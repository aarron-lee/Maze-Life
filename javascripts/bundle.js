...
var handleModalButtons = function handleModalButtons() {
  var generatorsModalButton = document.getElementById('#generators-modal');
  var solversModalButton = document.getElementById('#solvers-modal');
  var modalDiv = document.querySelector('#modal-location');

  generatorsModalButton.addEventListener("click", function (e) {
    e.preventDefault();
    var html = '<div class="modal-backdrop"><div class="modal-inner"><h2>Maze Generators</h2>';
  ...
  solversModalButton.addEventListener("click", function (e) {
    e.preventDefault();
    var html = '<div class="modal-backdrop"><div class="modal-inner"><h2>Maze Solvers</h2>';
